import type {ImageSize, ImageSizes} from "./types.js";
import {
    clearDestination,
    copyOriginalFile,
...
export async function processImages(options:ProcessImageOptions) {
    try {
        const {sizes} = options;
...
export async function resizeImage(buffer: Buffer, width: number, filename: string) {
    try {
